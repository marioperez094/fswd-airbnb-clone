...
class BookingWidget extends React.Component {
  ...
  onFocusChange = (focusedInput) => {
    ...
    this.dayBlockedFocus(focusedInput)
  }

  dayBlockedFocus = (focusedInput) => {
    if(focusedInput === 'startDate') {
      return this.setState({ inclusion: '[)'})
    }
    return this.setState({ inclusion: '(]'})
  }

  isDayBlocked = day => this.state.existingBookings.filter(b => day.isBetween(b.start_date, b.end_date, 'day', this.state.inclusion)).length > 0;
